...
export const listarTareas = async (req, res) => {
    ...
    const resultado = pool.query('SELECT * FROM tareas WHERE usuario_id = $1', [req.usuarioId]);
...
export const crearTarea = async (req, res, next) => {
    ...
    try {
        const result = await pool.query('INSERT INTO tareas ( titulo, descripcion) VALUES ($1, $2, $3) RETURNING *', [ titulo, descripcion]); 
